        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                if ([ALAssetsLibrary authorizationStatus] == ALAuthorizationStatusDenied) {
                    NSString *errorMessage = NSLocalizedString(@"应用程序不能访问您的照片或视频。你可以在隐私设置访问.", nil);
                    [[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"拒绝访问", nil) message:errorMessage delegate:nil cancelButtonTitle:NSLocalizedString(@"确认", nil) otherButtonTitles:nil] show];
                  
                } else {
                    NSString *errorMessage = [NSString stringWithFormat:@"相册错误: %@ - %@", [error localizedDescription], [error localizedRecoverySuggestion]];
                    [[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"错误", nil) message:errorMessage delegate:nil cancelButtonTitle:NSLocalizedString(@"确认", nil) otherButtonTitles:nil] show];
                }
